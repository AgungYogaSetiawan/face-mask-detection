...
Special thanks to whitphx and soft-nougat :)
"""
import threading
...
def streamlit_webrtc_snapshot():
    ...
    # call streamer
    ctx = webrtc_streamer(key="snapshot", client_settings=WEBRTC_CLIENT_SETTINGS, video_transformer_factory=VideoTransformer)
